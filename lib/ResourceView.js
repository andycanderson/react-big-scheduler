    ...
    _createClass(ResourceView, [{
        ...
        value: function render() {
            ...
            var resourceList = displayRenderData.map(function (item) {
                ...
                if (item.hasChildren) {
                    indent = item.expanded ? _react2.default.createElement(_icons.MinusSquareOutlined, { type: 'minus-square', key: 'es' + item.indent, style: {}, className: '',
                        onClick: function onClick() {
                            if (!!toggleExpandFunc) toggleExpandFunc(schedulerData, item.slotId);
                        } }) : _react2.default.createElement(_icons.PlusSquareOutlined, { key: 'es' + item.indent, style: {}, className: '',
                        onClick: function onClick() {
                            if (!!toggleExpandFunc) toggleExpandFunc(schedulerData, item.slotId);
                        } });
                }
